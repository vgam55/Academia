<div id="aniadir">
		<form style="display:inline">
		    ...
		    <label for="filtrarTelefono">Telefono</label>
		   	...
		   	<br>
			<label for="superAdmin">SuperAdministrador</label>
			<input type="radio" value="1" name="rol" id="superAdmin"> 
			<label for="administador">Administrador</label>
		   	<input type="radio" value="2" name="rol" id="administrador"> 
			<label for="profesor">Profesor</label>
			<input type="radio" value="3" name="rol" id="profesor"> 
