...
@section('content')
  <div id="container" class="container-fluid">
  	...
  	<div>
  		<i class='iconos fas fa-user-tie' style='color: black'></i> <h2 class=' d-inline-block align-middle mr-2 col-10'>USUARIOS <button class="btn btn-primary btnAniadir"><i class='fas fa-plus' ></i>  Añadir Usuario</button></h2>
    </div>
